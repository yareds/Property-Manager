...
import { GetchLogo } from './components/GetchLogo';
      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col items-center">
            <GetchLogo variant="full" />
            <p className="text-xs text-slate-400 font-medium mt-2">Real Estate Asset Lease Management</p>
          </div>
    ...
    <div className="min-h-screen bg-slate-100 text-slate-800 flex flex-col md:flex-row font-sans">
      ...
      <aside className="hidden md:flex flex-col w-[220px] bg-[#0f172a] text-[#cbd5e1] shrink-0 border-r border-[#1e293b] justify-between">
        <div className="flex flex-col">
          ...
          {/* Header */}
          <div className="px-5 py-[18px] border-b border-[#1e293b] flex items-center justify-between">
            <GetchLogo variant="sidebar" />
            {isGuest && (
      ...
      <div className="md:hidden flex items-center justify-between bg-slate-900 text-white p-4 shrink-0 shadow-lg relative z-40">
        <div className="flex items-center space-x-2">
          <button
            onClick={logout}
            className="p-1.5 mr-0.5 hover:bg-slate-800 rounded text-slate-400 hover:text-red-400 transition"
            title="Logout"
          >
            <LogOut size={16} />
          </button>
          <GetchLogo variant="compact" />
        </div>
