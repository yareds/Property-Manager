    ...
    <div className="space-y-4">
      ...
      {deleteConfirm && (
        <ConfirmModal
          ...
          message={`Are you sure you want to delete maintenance work order "${deleteConfirm.title}"? This action cannot be undone.`}
          confirmLabel="Delete Request"
          cancelLabel="Cancel"
          isDanger={true}
          onConfirm={() => {
            deleteMaintenance(deleteConfirm.requestId);
